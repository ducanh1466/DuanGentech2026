...
match ($action) {
    ...
    'client-reply-review' => (new HomeController)->clientReplyReview(),
    ...
    'admin-delete-review'   => (new AdminController)->deleteReview(),
    'admin-reply-review'    => (new AdminController)->replyReview(),
