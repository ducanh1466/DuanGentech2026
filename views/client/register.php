<section class="auth-page">
    <div class="auth-card" style="max-width:480px;">
        ...
        <form method="POST" action="<?= BASE_URL ?>?action=post-register">
            <div class="mb-3">
            ...
            <div class="form-check mb-3">
                ...
                <label class="form-check-label text-secondary" for="agreeTerms" style="font-size:0.85rem;">
                    Tôi đồng ý với <a href="#" class="text-accent">Điều khoản dịch vụ</a> và <a href="#"
                        class="text-accent">Chính sách bảo mật</a>
                </label>
            </div>
